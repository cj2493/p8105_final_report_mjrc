...
Code for reading in, merging, and cleaning our data:
```{r}
...
Below is the code we used to read in and clean our data:


Similar to downloading our initial data, variable obtaining issues progressed when attempting to scrape the data for our data dictionary. Therefore, we copyied the data dictionary given on the website and pasted into an excel file. Below is the link to the excel data dictionary file:

https://drive.google.com/file/d/1Myn3kicEjmmeD2PGoOehSlA30UtFfaV9/view?usp=sharing


Code creating a data dictionary to define everything in the final fully joined dataset. 
=======
...
>>>>>>> 037df13f991349d5d7006eec90ba91725363dc45
